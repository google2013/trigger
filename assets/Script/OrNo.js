cc.Class({
    ...
    showState: function (S, R, Q) {
        ...
        if (S == 1 && R == 0) {
            ...
            this.drawLine(7, 3, 0);
            this.drawLine(9, 4, 0);
            this.drawLine(11, 5, 0);
            this.drawLine(15, 7, 1);
            this.drawLine(16, 8, 1);
            this.drawLine(18, 9, 1);
            this.drawLine(20, 10, 1);
            this.drawLine(22, 11, 1);
            this.scheduleOnce(()=>{
                this.isShowing = null;
            }, 24);
        }
            ...
            this.drawLine(5, 8, 0);
            this.drawLine(7, 9, 0);
            this.drawLine(9, 10, 0);
            this.drawLine(11, 11, 0);
            this.drawLine(15, 1, 1);
            this.drawLine(16, 2, 1);
            this.drawLine(18, 3, 1);
            this.drawLine(20, 4, 1);
            this.drawLine(22, 5, 1);
            this.scheduleOnce(()=>{
                this.isShowing = null;
            }, 24);
        }
    ...
    _onClick: function (id) {
        ...
        if (id == 0 || id == 1) {
            ...
            this.showState(0, 0, 0);
        }
        else if (id == 7) {
            this.showState(0, 0, 1);
        }
    },
